...
require "mongo_inviteable/version"

Gem::Specification.new do |s|
  s.name        = "mongo_inviteable"
  s.version     = Mongo::Inviteable::VERSION
  s.authors     = ["Jie Fan"]
  s.email       = ["ustc.flyingfox@gmail.com"]
#  s.homepage    = "https://github.com/lastomato/mongo_inviteable"
  s.summary     = %q{ adds inviting feature to mongoid/mongo_mapper }
  s.description = %q{ Mongo Inviteable adds inviting feature to mongoid/mongo_mapper }

#  s.rubyforge_project = "mongo_inviteable"
