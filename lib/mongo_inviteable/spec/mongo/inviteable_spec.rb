...
describe Mongo::Inviteable do
  describe User do
    ...
    context "begins" do
      ...
      it "inviting a user" do
        ...
        u.ever_invite.should =~ [v, g]
        v.ever_invited.should == [u]

        u.ever_invite?(v).should be_true
        u.ever_invite?(g).should be_true
      ...
      it "inviting a group" do
        ...
        u.ever_invite.should =~ [g, v]
        g.ever_invited.should == [u]

        u.clear_invite_history!
        u.ever_invite.should == []
  ...
  describe Group do
    ...
    context "begins" do
      ...
      it "another way to uninvite a group" do
        u.invite(g)
        v.invite(g)
        w.invite(g)
  ...
  describe User do
    ...
    context "begins" do
      ...
      it "block test" do
        u.invite(v, w, g) {|m| m.class == User}

        u.all_invitees.should =~ [v, w]
      end

      it "block test uninvite" do
        u.uninvite(v, w, g) {|m| m.invitee_of? u}
